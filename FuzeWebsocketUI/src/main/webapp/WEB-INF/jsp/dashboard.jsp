...
<body id="page-top">
	<div id="wrapper">
		<ul
			...
			<li><a
				...
				href="index.html"> <span class="sidebar-brand-icon rotate-n-15">
						<i class="fas fa-laugh-wink"></i>
				</span> <span class="sidebar-brand-text mx-3"> FUZE <sup>Ginger</sup>
				</span>
			</a>
			...
			<li class="nav-item active"><a class="nav-link" href="/"> <i
					class="fas fa-fw fa-table"></i> <span>Home</span></a>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								...
								id="currentEmployee">Roshan Sigh</span> <img
							...
							aria-labelledby="userDropdown"> <a class="dropdown-item"
								href="#"> <i
									...
									Activity Log
							</a> <span class="dropdown-divider"></span> <a class="dropdown-item"
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary d-inline">Purchase
								Order</h6>
	...
	<script
		src="https://kendo.cdn.telerik.com/2020.1.406/js/kendo.all.min.js"></script>
	<script
